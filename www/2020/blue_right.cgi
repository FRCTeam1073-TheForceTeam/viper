...
print "</td></tr><tr>\n";
print "<th colspan=2><img src=blue_power_port.jpg></th>\n";
...
print "<table cellspacing=0 cellpadding=0 border=1 bordercolor=blue>\n";
my $index = 0;
for (my $j = 1; $j < 6; $j++) {
	print "<tr>\n";
	for (my $i = 1; $i < 6; $i++) {
		...
		my $sstr = join "", @tmparr;
		print "<td><a href=\"${me}?game=${game}&team=${team}&auto=${auto}&teleop=${teleop}&missed=${missed}&ctrl=${ctrl}&shotloc=${sstr}\"><img src=left_blue_${j}_${i}${mark}.png></td>\n";
		$index--;
	}
	print "</tr>\n";
}
