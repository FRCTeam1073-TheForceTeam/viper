...
addI18n({
	...
	event_upload_link:{
		...
		es:'Cargar datos de exploración (Partidas: _UPLOADCOUNT_)',
	...
	first_ranking_link:{
		...
		es:'Clasificaciones de calificación',
	...
	csv_event:{
		...
		es:'CSV de información de evento',
	...
	csv_subjective:{
		...
		es:'CSV de exploración subjetiva',
	...
	json_info:{
		...
		es:'JSON de información de evento de API',
	...
	json_teams:{
		...
		es:'JSON de lista de equipos de API',
	...
	json_schedule_practice:{
		...
		es:'JSON de horario de práctica de API',
	...
	json_schedule_qualification:{
		...
		es:'JSON de horario de calificación de API',
	...
	json_schedule_playoff:{
		...
		es:'JSON de horario de playoff de API',
	...
	json_scores_qualification:{
		...
		es:'JSON de puntuaciones de calificación de API',
	...
	json_scores_playoff:{
		...
		es:'JSON de puntuaciones de playoff de API',
	...
	predict_link:{
		...
		es:'Predecir resultado de partida',
	...
	planner_link:{
		...
		es:'Ver planificador y pizarra blanca',
	...
	aggregation_includes_practice:{
		...
		es:'* La agregación incluye partidas de práctica',
	...
	aggregation_excludes_practice:{
		...
		es:'* La agregación excluye partidas de práctica',
